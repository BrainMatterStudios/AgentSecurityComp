...
- **L15 (5 subs) PENDING** — fired 2026-08-03 00:40 UTC (aim-higher/per-model-FRAC night). Poller `dev/_poll_l15.py` **LAUNCHED** (caffeinated) → `logs/l15_results.log`; scores ~3h. Refs: 55198318 anchor sharedFRAC97 · 55198319 ASYM gpt97/gemma99 · 55198321 ASYM gpt98/gemma99 · 55198324 DEPUTY FRAC95 (private hedge) · 55198325 SHARED FRAC98. Versions `logs/l15_versions.json`. Today's quota SPENT (5/5). **Read:** best of {asym,shared} vs anchor — >+2 ⇒ gemma FRAC headroom exists (push next night); flat/neg/void ⇒ plateau at the void wall confirmed → weight to private hedge + write-up. DEPUTY public read validates it doesn't void (⇒ selectable private hedge).
