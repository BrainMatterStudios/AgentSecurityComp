#!/usr/bin/env python3
"""Push the five L20 kernels sequentially and record saved versions."""
...
LOG = os.path.join(ROOT, "logs", "l20_push.log")
VJSON = os.path.join(ROOT, "logs", "l20_versions.json")

PENDING = [
    ("submission_kernel_l20_anchor", "ahmedmobasher86/jed-public-pt-safe"),
    ("submission_kernel_l20_n1200", "ahmedmobasher86/jed-public-pt-probe"),
    ("submission_kernel_l20_n1320", "ahmedmobasher86/jed-public-k1nx-1000"),
    ("submission_kernel_l20_n1420", "ahmedmobasher86/jed-public-k1nx-1200"),
    ("submission_kernel_l20_deputy", "ahmedmobasher86/jed-public-k1nx-800"),
]
VERSIONS = {}
MAX_PUSH_ATTEMPTS = int(os.getenv("L20_PUSH_ATTEMPTS", "30"))
...
def main():
    log("L20 sequential CPU-save push start (5 kernels).")
