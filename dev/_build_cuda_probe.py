...
HARNESS_B64 = base64.b64encode((ROOT / "dev" / "_cuda_harness.py").read_bytes()).decode()
...
CELL_SETUP = (
    ...
    + "open('/kaggle/working/_cuda_harness.py','wb').write(base64.b64decode('%s'))\n" % HARNESS_B64
...
runpy.run_path("/kaggle/working/_cuda_harness.py", run_name="__main__")
'''
...
def main():
    d = ROOT / "submission_kernel_cuda_probe"
    ...
    meta = {
        "id": "ahmedmobasher86/jed-cuda-probe",
        "title": "jed cuda probe",
        "code_file": "k.ipynb",
        "language": "python",
    ...
    print("built", d, "-> ahmedmobasher86/jed-cuda-probe")
