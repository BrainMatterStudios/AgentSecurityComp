...
# L8 = MESSAGE-PACKING A/B. All rungs FRAC=97 (proven sweet spot) + bare marker +
# close_ok. Vary JED_RS_PACK (posts per candidate under ONE build_attack_env) to
# measure whether Kaggle's per-candidate env-build overhead amortizes. slot1 = the
# single-post floor (=87.48 rebank / regime canary); K=2/4/8 characterize the curve;
# K=4@FRAC95 is the safe FRAC-comparison rung. Packing degrades to single-post per
# board if it can't pack (gemma), so no rung is worse than 1x.
RUNGS = [
    ("submission_kernel_l8_floor", "ahmedmobasher86/jed-public-pt-safe", "jed public pt safe",
     {"JED_REPLAY_SAFE": 1, "JED_RS_FRAC": 97, "JED_EXFIL_PAYLOAD": "SECRET_MARKER"},
     "L8 FLOOR single-post FRAC=97 close_ok (=87.48 rebank / regime canary)"),
    ("submission_kernel_l8_k2", "ahmedmobasher86/jed-public-pt-probe", "jed public pt probe",
     {"JED_REPLAY_SAFE": 1, "JED_RS_FRAC": 97, "JED_EXFIL_PAYLOAD": "SECRET_MARKER", "JED_RS_PACK": 2},
     "L8 PACK K=2 FRAC=97 (env-build amortization A/B)"),
    ("submission_kernel_l8_k4", "ahmedmobasher86/jed-public-k1nx-1000", "jed public k1nx 1000",
     {"JED_REPLAY_SAFE": 1, "JED_RS_FRAC": 97, "JED_EXFIL_PAYLOAD": "SECRET_MARKER", "JED_RS_PACK": 4},
     "L8 PACK K=4 FRAC=97 (env-build amortization A/B)"),
    ("submission_kernel_l8_k8", "ahmedmobasher86/jed-public-k1nx-1200", "jed public k1nx 1200",
     {"JED_REPLAY_SAFE": 1, "JED_RS_FRAC": 97, "JED_EXFIL_PAYLOAD": "SECRET_MARKER", "JED_RS_PACK": 8},
     "L8 PACK K=8 FRAC=97 (env-build amortization A/B, max)"),
    ("submission_kernel_l8_k4safe", "ahmedmobasher86/jed-public-k1nx-800", "jed public k1nx 800",
     {"JED_REPLAY_SAFE": 1, "JED_RS_FRAC": 95, "JED_EXFIL_PAYLOAD": "SECRET_MARKER", "JED_RS_PACK": 4},
     "L8 PACK K=4 FRAC=95 (safe FRAC-comparison rung)"),
]
