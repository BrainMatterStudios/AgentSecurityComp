...
| Episode final statuses | `confirmed`: 5; `partially supported`: 9; `refuted`: 7; `invalid experiment`: 5; `superseded`: 1; `open`: 4 | Status applies only to the bounded claim in its row |
...
ARC-S01, ARC-S02, ARC-S10, OC-S01, OC-S05; `refuted` AS-S06, AS-S11, AS-S12,
AS-S13, ARC-S08, ARC-S09, ARC-S11; `invalid experiment` AS-S07, AS-S08,
ARC-S03, ARC-S05, OC-S04; `superseded` ARC-S04; `open` AS-S14, ARC-S12,
