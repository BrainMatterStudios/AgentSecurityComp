#!/usr/bin/env python3
"""Sequentially push the 5 L16 per-model-FRAC kernels (respecting the 2-GPU-session cap),
waiting for each save-run to finish before the next. Records versions to
logs/l16_versions.json for the submit step. Logs to logs/l16_push.log."""
import os, re, time, json, subprocess, datetime as dt
ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
LOG = os.path.join(ROOT, "logs", "l16_push.log")
VJSON = os.path.join(ROOT, "logs", "l16_versions.json")

PENDING = [
    ("submission_kernel_l16_anchor", "ahmedmobasher86/jed-public-pt-safe"),
    ("submission_kernel_l16_dep85", "ahmedmobasher86/jed-public-pt-probe"),
    ("submission_kernel_l16_dep90", "ahmedmobasher86/jed-public-k1nx-1000"),
    ("submission_kernel_l16_dep95", "ahmedmobasher86/jed-public-k1nx-1200"),
    ("submission_kernel_l16_dep97", "ahmedmobasher86/jed-public-k1nx-800"),
]
VERSIONS = {}
...
def main():
    log("L16 sequential push start (5 kernels).")
