#!/usr/bin/env python3
"""Push the five L18 kernels sequentially and record saved versions."""
...
LOG = os.path.join(ROOT, "logs", "l18_push.log")
VJSON = os.path.join(ROOT, "logs", "l18_versions.json")

PENDING = [
    ("submission_kernel_l18_anchor_rs97", "ahmedmobasher86/jed-public-pt-safe"),
    ("submission_kernel_l18_aco8n60", "ahmedmobasher86/jed-public-pt-probe"),
    ("submission_kernel_l18_aco8n120", "ahmedmobasher86/jed-public-k1nx-1000"),
    ("submission_kernel_l18_split_safe", "ahmedmobasher86/jed-public-k1nx-1200"),
    ("submission_kernel_l18_aco8n230", "ahmedmobasher86/jed-public-k1nx-800"),
]
VERSIONS = {}
MAX_PUSH_ATTEMPTS = int(os.getenv("L18_PUSH_ATTEMPTS", "30"))
...
def main():
    log("L18 sequential CPU-save push start (5 kernels).")
