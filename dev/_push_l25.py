#!/usr/bin/env python3
"""Push the five L25 dual-forge kernels sequentially (CPU save-run) and record versions
to logs/l25_versions.json. Reuses the 5 L24 slugs -> each push bumps the version."""
...
LOG = os.path.join(ROOT, "logs", "l25_push.log")
VJSON = os.path.join(ROOT, "logs", "l25_versions.json")

PENDING = [
    ("submission_kernel_l25_single", "ahmedmobasher86/jed-public-pt-safe"),
    ("submission_kernel_l25_gemforge_k4", "ahmedmobasher86/jed-public-pt-probe"),
    ("submission_kernel_l25_gemsingle", "ahmedmobasher86/jed-public-k1nx-1000"),
    ("submission_kernel_l25_dual_k4", "ahmedmobasher86/jed-public-k1nx-1200"),
    ("submission_kernel_l25_dual_k3", "ahmedmobasher86/jed-public-k1nx-800"),
]
VERSIONS = {}
MAX_PUSH_ATTEMPTS = int(os.getenv("L25_PUSH_ATTEMPTS", "30"))
...
def main():
    log("L25 sequential CPU-save push start (5 kernels).")
