...
PROFILES = {
    ...
    "v312_fstop_800": {"dir": "submission_kernel_v312_fstop_800", "id": "ahmedmobasher86/jed-public-k1nx-1000",
    ...
    # === Day-4 PLAIN-prompt static ladder. The terminator bracket voided (all >=500),
    # but those were terse/terminator prompts that likely SLOW a reasoning model. This
    # measures the true cal_t boundary of the PROVEN plain prompt (idx0 = _p_k1_short,
    # the one k1_300=27 used) at N=380/460/540/620 => brackets cal_t 23.7/19.6/16.7/14.5s.
    # Highest valid rung banks the score; k1_300=27 stays the protected floor. ===
    "v312_plain_380": {"dir": "submission_kernel_v312_plain_380", "id": "ahmedmobasher86/jed-public-k1-630",
        "title": "JED Public K1_630",
    ...
    "v312_plain_460": {"dir": "submission_kernel_v312_plain_460", "id": "ahmedmobasher86/jed-public-k1-640",
        "title": "JED Public K1_640",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "0",
                "JED_MAX_CANDIDATES": "460", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "v312_plain_540": {"dir": "submission_kernel_v312_plain_540", "id": "ahmedmobasher86/jed-public-k1-650",
        "title": "JED Public K1_650",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "0",
                "JED_MAX_CANDIDATES": "540", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "v312_plain_620": {"dir": "submission_kernel_v312_plain_620", "id": "ahmedmobasher86/jed-public-k1-660",
    ...
    # === MEASURED-optimal prompt (idx6 _p_k1_minimal, .com hosts). Exact-model
    # cal_t ~120 tok vs 183 -> boundary ~450 -> ~700. Static ladder N=600/700 to
    # confirm the ~1.5x win on Kaggle (-> ~54/~63). T4 (only honored accelerator). ===
    "m6_600": {"dir": "submission_kernel_m6_600", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "6",
                "JED_MAX_CANDIDATES": "600", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "m6_700": {"dir": "submission_kernel_m6_700", "id": "ahmedmobasher86/jed-public-k1nx-760",
        "title": "JED Public K1NX_760", "accel": "NvidiaTeslaT4",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "6",
                "JED_MAX_CANDIDATES": "700", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    # === Day-5 minimal-prompt boundary ladder (idx6 + .com, T4). m6 N=600 voided
    # => gpt-oss boundary ~570; this brackets it. N=440 is a near-certain floor
    # (>34.2 guaranteed); highest valid rung banks the score (~40/45/49/52). ===
    "m6_440": {"dir": "submission_kernel_m6_440", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "6",
                "JED_MAX_CANDIDATES": "440", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "m6_500": {"dir": "submission_kernel_m6_500", "id": "ahmedmobasher86/jed-public-k1nx-760",
        "title": "JED Public K1NX_760", "accel": "NvidiaTeslaT4",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "6",
                "JED_MAX_CANDIDATES": "500", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "m6_540": {"dir": "submission_kernel_m6_540", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "6",
                "JED_MAX_CANDIDATES": "540", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "m6_580": {"dir": "submission_kernel_m6_580", "id": "ahmedmobasher86/jed-public-k1nx-1000",
    ...
    "fp_a": {"dir": "submission_kernel_fp_a", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_FP_PORTFOLIO": "1", "JED_GPTOSS_MP_N": "58", "JED_GEMMA_SP_N": "460",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "fp_b": {"dir": "submission_kernel_fp_b", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_FP_PORTFOLIO": "1", "JED_GPTOSS_MP_N": "70", "JED_GEMMA_SP_N": "480",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "fp_c": {"dir": "submission_kernel_fp_c", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_900", "accel": "NvidiaTeslaT4",
        "env": {"JED_FP_PORTFOLIO": "1", "JED_GPTOSS_MP_N": "80", "JED_GEMMA_SP_N": "500",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "fp_d": {"dir": "submission_kernel_fp_d", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_1000", "accel": "NvidiaTeslaT4",
        "env": {"JED_FP_PORTFOLIO": "1", "JED_GPTOSS_MP_N": "88", "JED_GEMMA_SP_N": "515",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "sp_bank": {"dir": "submission_kernel_sp_bank", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "450", "JED_GEMMA_N": "470",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "mp_iso": {"dir": "submission_kernel_mp_iso", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_FP_PORTFOLIO": "1", "JED_GPTOSS_MP_N": "85", "JED_GEMMA_SP_N": "440",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gemma_probe": {"dir": "submission_kernel_gemma_probe", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_1000", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "400", "JED_GEMMA_N": "750",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gs_500": {"dir": "submission_kernel_gs_500", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "430", "JED_GEMMA_N": "500",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gs_580": {"dir": "submission_kernel_gs_580", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "430", "JED_GEMMA_N": "580",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gs_660": {"dir": "submission_kernel_gs_660", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_900", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "430", "JED_GEMMA_N": "660",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gp_620": {"dir": "submission_kernel_gp_620", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_1000", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "620",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gp_648": {"dir": "submission_kernel_gp_648", "id": "ahmedmobasher86/jed-public-k1nx-760",
        "title": "JED Multi-Step Tool Attack", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "648",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gp_800": {"dir": "submission_kernel_gp_800", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public GP_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "800",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gp_720": {"dir": "submission_kernel_gp_720", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public GP_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "720",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "at_640": {"dir": "submission_kernel_at_640", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED AT 640", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "640",
                "JED_GEMMA_PROMPT": "12", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "at_800": {"dir": "submission_kernel_at_800", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX 1000", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "800",
                "JED_GEMMA_PROMPT": "12", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "at_950": {"dir": "submission_kernel_at_950", "id": "ahmedmobasher86/jed-public-k1-630",
        "title": "JED Public K1 630", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "950",
                "JED_GEMMA_PROMPT": "12", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "at_1100": {"dir": "submission_kernel_at_1100", "id": "ahmedmobasher86/jed-public-k1-640",
        "title": "JED Public K1 640", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "1100",
                "JED_GEMMA_PROMPT": "12", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "nb_480": {"dir": "submission_kernel_nb_480", "id": "ahmedmobasher86/jed-public-k1-700",
        "title": "JED Public K1 700", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "480",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "nb_560": {"dir": "submission_kernel_nb_560", "id": "ahmedmobasher86/jed-public-k1-780",
        "title": "JED Public K1 780", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "560",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "nb_600": {"dir": "submission_kernel_nb_600", "id": "ahmedmobasher86/jed-public-k1-860",
        "title": "JED Public K1 860", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "600",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "nb_640": {"dir": "submission_kernel_nb_640", "id": "ahmedmobasher86/jed-public-k1-940",
        "title": "JED Public K1 940", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "640",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "inj_p": {"dir": "submission_kernel_inj_p", "id": "ahmedmobasher86/jed-public-k1-700",
        "title": "JED Public K1 700", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "1000", "JED_GPTOSS_PROMPT": "13",
                "JED_GEMMA_N": "560", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "inj_760": {"dir": "submission_kernel_inj_760", "id": "ahmedmobasher86/jed-public-k1-780",
        "title": "JED Public K1 780", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "760", "JED_GPTOSS_PROMPT": "13", "JED_GEMMA_N": "1150", "JED_GEMMA_PROMPT": "12", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "inj_620": {"dir": "submission_kernel_inj_620", "id": "ahmedmobasher86/jed-public-k1-860",
        "title": "JED Public K1 860", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "490", "JED_GEMMA_N": "800", "JED_GEMMA_PROMPT": "12", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "tclean": {"dir": "submission_kernel_tclean", "id": "ahmedmobasher86/jed-public-k1-940",
        "title": "JED Public K1 940", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "900",
                "JED_GEMMA_PROMPT": "12", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gp_640": {"dir": "submission_kernel_gp_640", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "440", "JED_GEMMA_N": "640",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_200": {"dir": "submission_kernel_gk_200", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_GPT_N": "435", "JED_GEMMA_K": "3", "JED_GEMMA_N": "200",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_260": {"dir": "submission_kernel_gk_260", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_GPT_N": "435", "JED_GEMMA_K": "3", "JED_GEMMA_N": "260",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_320": {"dir": "submission_kernel_gk_320", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_900", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_GPT_N": "435", "JED_GEMMA_K": "3", "JED_GEMMA_N": "320",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "inj_top": {"dir": "submission_kernel_inj_top", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_1000", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_GPT_PROMPT": "7", "JED_GPT_N": "650", "JED_GEMMA_K": "1", "JED_GEMMA_N": "640",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "sqz_49": {"dir": "submission_kernel_sqz_49", "id": "ahmedmobasher86/jed-public-k1nx-760",
        "title": "JED Multi-Step Tool Attack", "accel": "NvidiaTeslaT4",
        "env": {"JED_AGG_PROBE": "1", "JED_GPTOSS_N": "445", "JED_GEMMA_N": "650",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_800": {"dir": "submission_kernel_gk_800", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX_720", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_SHORT_URL": "1", "JED_GPT_PROMPT": "0", "JED_GPT_N": "490",
                "JED_GEMMA_PROMPT": "12", "JED_GEMMA_K": "1", "JED_GEMMA_N": "900",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_1000": {"dir": "submission_kernel_gk_1000", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX_800", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_SHORT_URL": "1", "JED_GPT_PROMPT": "0", "JED_GPT_N": "490",
                "JED_GEMMA_PROMPT": "12", "JED_GEMMA_K": "1", "JED_GEMMA_N": "1120",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_1200": {"dir": "submission_kernel_gk_1200", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_900", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_SHORT_URL": "1", "JED_GPT_PROMPT": "0", "JED_GPT_N": "490",
                "JED_GEMMA_PROMPT": "12", "JED_GEMMA_K": "1", "JED_GEMMA_N": "1240",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_780": {"dir": "submission_kernel_gk_780", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_1000", "accel": "NvidiaTeslaT4",
        "env": {"JED_GK_PROBE": "1", "JED_SHORT_URL": "1", "JED_GPT_PROMPT": "0", "JED_GPT_N": "440",
    ...
    "gk_820": {"dir": "submission_kernel_gk_820", "id": "ahmedmobasher86/jed-public-k1nx-720",
        "title": "JED Public K1NX 720", "env": {"JED_GK_PROBE": "1", "JED_SHORT_URL": "1", "JED_GPT_PROMPT": "0", "JED_GPT_N": "440",
                "JED_GEMMA_PROMPT": "12", "JED_GEMMA_K": "1", "JED_GEMMA_N": "830",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_860": {"dir": "submission_kernel_gk_860", "id": "ahmedmobasher86/jed-public-k1nx-800",
        "title": "JED Public K1NX 800", "env": {"JED_GK_PROBE": "1", "JED_SHORT_URL": "1", "JED_GPT_PROMPT": "0", "JED_GPT_N": "440",
                "JED_GEMMA_PROMPT": "12", "JED_GEMMA_K": "1", "JED_GEMMA_N": "870",
                "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "gk_870": {"dir": "submission_kernel_gk_870", "id": "ahmedmobasher86/jed-public-k1nx-1000",
    ...
    "mp_90": {"dir": "submission_kernel_mp_90", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_900", "accel": "NvidiaTeslaT4",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "11",
    ...
    "inj_dev_700": {"dir": "submission_kernel_inj_dev_700", "id": "ahmedmobasher86/jed-public-k1nx-800",
        ...
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "8",
                "JED_MAX_CANDIDATES": "700", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "inj_effort_700": {"dir": "submission_kernel_inj_effort_700", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_900", "accel": "NvidiaTeslaT4",
    ...
    "nc_460": {"dir": "submission_kernel_nc_460", "id": "ahmedmobasher86/jed-public-k1nx-800",
        ...
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "0",
                "JED_MAX_CANDIDATES": "460", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    "nc_540": {"dir": "submission_kernel_nc_540", "id": "ahmedmobasher86/jed-public-k1nx-1000",
        "title": "JED Public K1NX_900", "accel": "NvidiaTeslaT4",
        "env": {"JED_K1_SHORT": "1", "JED_K1_ADAPTIVE": "0", "JED_K1_PROMPT": "0",
                "JED_MAX_CANDIDATES": "540", "JED_MAX_PRIVATE_CHAINS": "0", "JED_SEARCH_FRACTION": "1"}},
    ...
    "k1nx_900": {"dir": "submission_kernel_k1nx_900", "id": "ahmedmobasher86/jed-public-k1nx-1000",
